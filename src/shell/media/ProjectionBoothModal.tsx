...
export function ProjectionBoothModal({
  ...
  const mtxNinjaRelayUrl = `https://vdo.ninja/?view=${encodeURIComponent(cleanMtxPath)}&mediamtx=${encodeURIComponent(cleanMtxHost)}:${encodeURIComponent(mtxWebRtcPort)}&cleanoutput=1&autoplay=1&transparent=0&autostart=1&nocontrols=1`;
